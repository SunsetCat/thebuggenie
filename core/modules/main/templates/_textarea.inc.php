    ...
    <?php if (!isset($hide_hint) || $hide_hint == false): ?>
        <div class="textarea_hint">
            <p class="syntax_pt_hint hint_container">
                ...
                ?><br>
                <?php echo __('See more formatting tips in %markdown_formatting.', array('%markdown_formatting' => '<a href="https://daringfireball.net/projects/markdown/syntax" target="_new" tabindex="-1">MarkdownFormatting</a>')); ?>
            </p>
